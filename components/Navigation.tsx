...
export default function Navigation({ activeTab, tabs, onTabClick }: NavigationProps) {
    return (
        <nav className="bg-blue-600 text-white" data-oid="58f03p8">
            <div className="container mx-auto px-4" data-oid="89c6ona">
                <div className="flex space-x-8 h-[40px]" data-oid="p4-.2xb">
                    {tabs.map((tab) => (
                        <button
                            key={tab.key}
                            onClick={() => onTabClick(tab.key)}
